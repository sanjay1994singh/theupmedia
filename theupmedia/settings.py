...
# 10 GB Limit (Practically Unlimited)
...
CONTACT_EMAIL = os.getenv("CONTACT_EMAIL", os.getenv("DEFAULT_FROM_EMAIL", "noreply@theupmedia.com"))
CONTACT_PHONE = os.getenv("CONTACT_PHONE", "+91 8279408396")
PUBLIC_SITE_URL = os.getenv("PUBLIC_SITE_URL", "https://theupmedia.in")
